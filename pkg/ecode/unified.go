...
const (
	...
	// client database
	MsgClientDatabaseOpenStart = "client database start"
	MsgClientDatabaseOpenPanic = "database open panic"
	MsgClientDatabasePingPanic = "database ping panic"
)
...
const (
	...
	// ModClientDatabase ...
	ModClientDatabase = "client.database"
	// ModXcronETCD ...
