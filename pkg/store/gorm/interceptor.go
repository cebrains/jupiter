...
//					options.logger.Error("database err", xlog.FieldErr(scope.DB().Error), xlog.FieldName(dsn.DBName+"."+scope.TableName()), xlog.FieldMethod(op))
//				} else {
...
//					span.SetTag("peer.service", options.Dialect)
